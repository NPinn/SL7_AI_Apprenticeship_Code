...
├── [03 Product Management for AI](./03_Product_Management_for_AI)
├── [04 Supervised Classification](./04_Supervised_Classification)
├── [05 Ensemble Methods](./05_Ensemble_Methods)
├── [06 Pragmatic Model Evaluation](./06_Pragmatic_Model_Evaluation)
├── [07 Unsupervised Learning](./07_Unsupervised_Learning)
├── [08 The AI Landscape](./08_The_AI_Landscape)
...
1. Create Folder Strucutre within [README.md](./README.md)
    1. Add Explinations to Folders within folderstructure
2. Add info on how to get lecture material not in folders